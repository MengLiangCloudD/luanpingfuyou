        ...
        <div class="contents">
            <div class="content"  v-for="(item,index) in neirong" :key="index">
                <div class="comment" v-if="item.type==1">
                    <div class="content1" >
                        <img src="./../../assets/头像.png" alt="" width="40px;" style="vertical-align: top;margin:0 15px;float: right;" >
                        <div class="send">
                            <p>{{item.content}}</p> 
                            <div class="arrow"></div>
                        </div>
                ...
                <div class="comment"  v-if="item.type==0">
                    <div class="content1">
                        <img src="./../../assets/avatar.png" alt="" width="40px;" style="vertical-align: top;margin:0 15px;" >
                        <div class="send1">
                            <p>{{item.content}}</p> 
...
<script>
    export default {
        ...
        mounted(){
             this.name = localStorage.getItem('dddName')
             this.scrollToBottom();
        }
    }
</script>
